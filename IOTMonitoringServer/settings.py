"""
FORK Afiffe Retamozo, Jorge Ballesteros
...
ALLOWED_HOSTS = ["localhost", "18.204.197.183"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.238.136.70",  # Dirección IP de la base de datos
